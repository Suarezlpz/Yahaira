...
export default function FreeSoloCreateOptionDialog() {
  ...
  const handleSubmit = (event) => {
    ...
    const nextPelicula = [
      ...
      ...peliculas.slice(0, insertAt),
      // Nuevo ítem:
      { title: dialogValue.title, year: parseInt(dialogValue.year, 10) },
      // Elementos después del punto de inserción:
      ...peliculas.slice(insertAt)
    ];
    setPeliculas(nextPelicula);
    setValue({
  ...
  return (
    <React.Fragment>
      <Autocomplete
        ...
        sx={{ width: 300 }}
        freeSolo
        renderInput={(params) => <TextField {...params} label="oli" />}
      />
